...
const target = path.join(__dirname, 'src/app/sessions/[id]/artist/[artistId]/page.tsx');
...
function getEmbedUrl(url: string) {
    if (!url) return '';
    if (url.includes('youtube.com/embed/')) return url; // ya está embebido
    let videoId = '';
...
console.log('Done rewriting artist detail page.');